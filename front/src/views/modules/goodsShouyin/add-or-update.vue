        ...
        <el-form
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="购买流水号" prop="goodsShouyinUuidNumber">
                       <el-input v-model="ruleForm.goodsShouyinUuidNumber"
                                 placeholder="购买流水号" clearable  :readonly="ro.goodsShouyinUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="goodsShouyinTypes">
                        <el-select v-model="ruleForm.goodsShouyinTypes" :disabled="ro.goodsShouyinTypes" placeholder="请选择支付类型">
                            <el-option
            ...
            return {
                ...
                rules: {
                   goodsShouyinUuidNumber: [
                              { required: true, message: '购买流水号不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
