    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品编号" prop="goodsUuidNumber">
                       <el-input v-model="ruleForm.goodsUuidNumber"
                                 placeholder="商品编号" clearable  :readonly="ro.goodsUuidNumber"></el-input>
                   </el-form-item>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="原价" prop="goodsNewMoney">
                       <el-input v-model="ruleForm.goodsNewMoney"
                                 placeholder="原价" clearable  :readonly="ro.goodsNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="原价" prop="goodsNewMoney">
                           <el-input v-model="ruleForm.goodsNewMoney"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价" prop="goodsXiaoshouMoney">
                       <el-input v-model="ruleForm.goodsXiaoshouMoney"
                                 placeholder="现价" clearable  :readonly="ro.goodsXiaoshouMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
