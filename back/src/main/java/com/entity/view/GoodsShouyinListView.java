...
public class GoodsShouyinListView extends GoodsShouyinListEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		//级联表 goods_shouyin
			...
			* 购买 的 用户
			*/
			private Integer goodsShouyinYonghuId;
			/**
			* 实付金额
			*/
		...
		try {
			...
			e.printStackTrace();
				...
				//级联表的get和set goods_shouyin
					...
					* 获取：购买 的 用户
					*/
					public Integer getGoodsShouyinYonghuId() {
						return goodsShouyinYonghuId;
					}
					/**
					* 设置：购买 的 用户
					*/
					public void setGoodsShouyinYonghuId(Integer goodsShouyinYonghuId) {
						this.goodsShouyinYonghuId = goodsShouyinYonghuId;
					}
