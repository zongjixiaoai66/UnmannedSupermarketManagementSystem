    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(goodsShouyin !=null){
            ...
            BeanUtils.copyProperties( goodsShouyin , view );//把实体数据重构到view中
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(goodsShouyin.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody GoodsShouyinEntity goodsShouyin, HttpServletRequest request){
        ...
        if(false)
            ...
            goodsShouyin.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<GoodsShouyinEntity> queryWrapper = new EntityWrapper<GoodsShouyinEntity>()
            ...
            .eq("yonghu_id", goodsShouyin.getYonghuId())
...
//            goodsShouyin.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R inGoodsShouyinList(@RequestBody  Map<String, Object> params,HttpServletRequest request){
        ...
        String yonghuid = String.valueOf(params.get("yonghuid"));//用户
        ...
        if(goodsList == null || goodsList.size() == 0){
            ...
            for(GoodsEntity w:goodsList){
                ...
                goodsShouyinTruePrice += w.getGoodsNewMoney() * map.get(String.valueOf(w.getId()));
            }
        }
        ...
        GoodsShouyinEntity goodsShouyinEntity = new GoodsShouyinEntity<>();
            ...
            if("用户".equals(role))
            goodsShouyinEntity.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            GoodsShouyinEntity goodsShouyinEntity = new GoodsShouyinEntity();
//                            goodsShouyinEntity.setGoodsShouyinUuidNumber(data.get(0));                    //购买流水号 要改的
//                            goodsShouyinEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            goodsShouyinEntity.setGoodsShouyinTruePrice(data.get(0));                    //实付金额 要改的
//                            goodsShouyinEntity.setGoodsShouyinTypes(Integer.valueOf(data.get(0)));   //支付类型 要改的
//                            goodsShouyinEntity.setGoodsShouyinContent("");//详情和图片
...
//                            goodsShouyinEntity.setCreateTime(date);//时间
                        ...
                        if(goodsShouyinEntities_goodsShouyinUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [购买流水号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
